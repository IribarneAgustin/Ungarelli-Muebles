...
<div class="row" style="padding: 50px">
    ...
    <div class="col-md-6 col-lg-4">
        <h3 class="text-center">Colores línea <b>Modern</b></h3>
        <br>
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="3000">
                    <img src="/image/baltico.webp" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                    <img src="/image/negro.webp" class="d-block w-100" alt="...">
                </div>
...
<div class="row">
    ...
    @if ($article->premium == 0 && $article->modern == 0)
...
<div class="text-center">
    <h2>Muebles línea <b>Modern</b></h2>
</div>
<hr>
